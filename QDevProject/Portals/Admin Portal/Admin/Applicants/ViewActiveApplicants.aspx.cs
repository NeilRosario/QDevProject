...
{
    public partial class ViewActiveApplicants : System.Web.UI.Page
    {
        ...
        void GetActiveApplicants()
        {
            ...
            {
                con.Open();
                string cmd = @"SELECT applicant_id, a_email, last_name + ', ' + first_name + ' ' + middle_name AS 'Full Name', date_of_birth, gender FROM applicant_basic_info where user_statusid !=2 ";
