<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HRPassedApplicant.aspx.cs" Inherits="RecruitMe.HRApp_process.HRPassedApplicant" %>
...
<asp:Content ID="process_application" ContentPlaceHolderID="MainContent"  runat="server">
    ...
    <Label id="test" Visible="false" runat="server" />
</asp:Content>