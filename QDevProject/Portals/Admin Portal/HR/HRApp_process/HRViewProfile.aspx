<%@ Page Language="C#" MasterPageFile="~/Site.Master" CodeBehind="HRViewProfile.aspx.cs" Inherits="RecruitMe.HRApp_process.HRViewProfile" %>
...
<asp:Content ID="process_application" ContentPlaceHolderID="MainContent"  runat="server">
    ...
    <div>
        ...
        <div>
            <asp:Label id="test_command" Visible="false" runat="server" />
        </div>
    </div>
